...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/openclaw/openclaw">OpenClaw</a> · 65 merged PRs</h3>
    ...
    <td width="50%" valign="top">
      ...
      <p>19 merged PRs across CLI capabilities, SDK behavior, H3 video integration, API-contract alignment, security, and release quality.</p>
...
<sub>Contribution counts above were verified on 2026-09-04 and link to merged-PR searches or individual merged PRs.</sub>
